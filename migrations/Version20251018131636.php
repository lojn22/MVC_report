 ...
 */
final class Version20251018131636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__player AS SELECT id, name, fullness, current_stage, visited_rooms, inventory FROM player');
        $this->addSql('DROP TABLE player');
        $this->addSql('CREATE TABLE player (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(50) NOT NULL, fullness INTEGER NOT NULL, current_stage INTEGER NOT NULL, visited_rooms CLOB NOT NULL --(DC2Type:json)
        , inventory CLOB NOT NULL --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO player (id, name, fullness, current_stage, visited_rooms, inventory) SELECT id, name, fullness, current_stage, visited_rooms, inventory FROM __temp__player');
